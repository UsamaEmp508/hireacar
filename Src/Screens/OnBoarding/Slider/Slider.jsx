...
const Slider = ({ navigation }) => {
  ...
  const renderItem = ({ item, index }) => {
    ...
    return (
      <View style={[styles.container, { backgroundColor: theme.sliderBackground }]}>
        <View style={styles.slide}>
          <Text style={[styles.title, { color: theme.WhiteColor }]}>{item.title}</Text>
          <Text style={[styles.text, { color: theme.WhiteColor }]}>{item.text}</Text>
        </View>
